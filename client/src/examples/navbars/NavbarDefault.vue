...
const fetchData = async () => {
    try {
        const response = await axios.get(
            `${import.meta.env.VITE_API_URL}/categories-with-subcategories`
        );
...
const infoWindowContent = (location: any) => {
    ...
    <div>
      ...
      <p><a class='mb-2' href="/product-pharmacy/${location.pharmacy_name}/${location._id}">Sản phẩm tại nhà thuốc</a></p>
            ...
            <div
                ...
                <div>
                    ...
                    <el-button
                        ...
                        @click="onShowPopupMap"
                        >Nhà thuốc gần bạn</el-button
                    >
                </div>
                            ...
                            <div class="d-none d-lg-block">
                                <ul class="list-group">
                                    <li
                                        ...
                                        <div
                                            class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                            <RouterLink
                                                :to="{
