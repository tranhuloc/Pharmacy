              ...
              <div class="card-body">
                <form role="form" class="text-start">
                  <MaterialInput
                    ...
                    :label="{ text: 'Họ và tên', class: 'form-label' }"
                    type="text"
                    v-model="fullname"
                  />
                  <MaterialInput
                  ...
                  <MaterialInput
                    ...
                    :label="{ text: 'Số điện thoại', class: 'form-label' }"
                    type="tel"
                    v-model="phone"
                  />
                  <MaterialInput
                    id="password"
                    class="input-group-outline mb-3"
                    :label="{ text: 'Mật khẩu', class: 'form-label' }"
                    type="password"
                    v-model="password"
                  />
                  <MaterialInput
                    id="confirm_password"
                    class="input-group-outline mb-3"
                    :label="{ text: 'Xác nhận mật khẩu', class: 'form-label' }"
                    type="password"
                  ...
                  <MaterialInput
                    id="address"
                    class="input-group-outline mb-3"
                    :label="{ text: 'Địa chỉ', class: 'form-label' }"
                    v-model="address"
                  />
