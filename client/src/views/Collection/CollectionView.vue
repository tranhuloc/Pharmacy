...
const fetchData = async () => {
  try {
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/subcategories/${collectionName.value}/${orderby}/products`);
...
<template>
  <BaseLayout :title="collectionName" :breadcrumb="[
