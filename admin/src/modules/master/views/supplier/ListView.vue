<template>
  <div class="vc-page page-supplier-list">
    <!-- breadcrumb block-->
    <vc-row>
...
import { colConfig, tableConfig } from '@/commons/config/supplier.config'
...
<style>
.page-supplier-list .inline-flex-container {
  display: inline-flex;
  align-items: center;
  white-space: nowrap;
}
